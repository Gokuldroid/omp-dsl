...
fun copy(copy: String, orginal: String){
    copyTask(copy, orginal, "D:\\newval\\dsl-bug\\O365 Manager Plus\\conf\\o365\\management\\O365LayoutComponentGroup.xml")
    copyTask(copy, orginal, "D:\\newval\\dsl-bug\\O365 Manager Plus\\conf\\o365\\management\\O365LayoutComponentRules.xml")
}
